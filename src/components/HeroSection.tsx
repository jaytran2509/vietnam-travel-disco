...
export function HeroSection({
  ...
  return (
    <div 
      className="relative h-[320px] md:h-[380px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary/90 to-primary"
    >
      <div
            ...
            {categories.map((category) => {
              ...
              return (
                <Badge
                  ...
                  className={cn(
                    'cursor-pointer px-3 py-1 text-xs font-semibold transition-all duration-200 shadow-sm',
                    isSelected 
